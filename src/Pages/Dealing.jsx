  ...
  return (
    <div className="home-background">
      ...
      <div id="dealing-content">
        <ol>
          <li className="steps">
            Both the dealer and player(s) are dealt two cards, but the dealer
            only shows one card while the other is kept face down.
            <br />
        ...
        <button onClick={handleDeal} className="deal-button">
          Deal
        </button>
      </div>
    </div>
